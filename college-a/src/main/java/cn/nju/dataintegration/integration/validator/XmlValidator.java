 ...
 * 喂给目标院系前调用本类做合法性校验。
 *
 * 资源约定（所有 XSD 都打包进 college-a 模块的 classpath）：
 *   - 规范格式（unified）：xsd/integration/formatStudent.xsd、formatClass.xsd、formatChoice.xsd
 *   - 院系 A 原生格式：     xsd/college-a/studentA.xsd、classA.xsd、choiceA.xsd、accountA.xsd
...
public final class XmlValidator {
    ...
    // 院系 A 原生格式 ----------------------------------------------------------
    public void validateCollegeAStudents(String xml) throws SAXException, IOException {
        validate(xml, "xsd/college-a/studentA.xsd");
    }

    public void validateCollegeAClasses(String xml) throws SAXException, IOException {
        validate(xml, "xsd/college-a/classA.xsd");
    }

    public void validateCollegeAChoices(String xml) throws SAXException, IOException {
        validate(xml, "xsd/college-a/choiceA.xsd");
    }

    public void validateCollegeAAccounts(String xml) throws SAXException, IOException {
        validate(xml, "xsd/college-a/accountA.xsd");
    }
