...
sequenceDiagram
    ...
    IS->>Bts: PICK|B240000001|AC2024001（源院 B 本地记录选课）
    Bts->>Bdb: INSERT ENROLLMENT
    Bts-->>IS: OK
...
![A院SC表新增B学生记录（DBeaver）](../screenshots/08-db-college-a-sc.png)

---

#### TC3 — 外院占位学生（C 学生选 B 共享课）

**操作**：C 院学生 C202401 → 跨院选 B 院共享课
...
|---|---|---|---|
| A | admin | A20240001 | 123456 |
| B | admin | B24000001 | 123456 |
| C | admin | C202401 | 123456 |
