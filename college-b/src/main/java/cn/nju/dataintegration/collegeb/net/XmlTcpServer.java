        ...
        try (socket) {
            ...
            try (Connection c = db.open()) {
                if ("GET_STUDENTS".equals(cmd)) {
                    serveXml(socket, exporter.exportStudents(c), "xsd/college-b/studentB.xsd");
                } else if ("GET_COURSES".equals(cmd)) {
                    serveXml(socket, exporter.exportCourses(c), "xsd/college-b/classB.xsd");
                } else if ("GET_CHOICES".equals(cmd)) {
                    serveXml(socket, exporter.exportChoices(c), "xsd/college-b/choiceB.xsd");
