...
public final class MainFrame extends JFrame {
    ...
    private final JComboBox<String> crossTargetBox = new JComboBox<>(new String[]{"A", "B"});
    ...
    private void doDrop() {
        try {
            ...
            JOptionPane.showMessageDialog(this, res.contains("OK") ? "退课成功（已通知集成服务器登记）" : "退课失败", "结果", JOptionPane.INFORMATION_MESSAGE);
            refreshAll();
        } catch (Exception ex) {
